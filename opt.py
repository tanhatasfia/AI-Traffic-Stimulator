...
def get_args():
    ...
    default=os.path.expanduser('~/Downloads/good_for_nothing'),
    ...
    parser.add_argument("--lr_transform", type=float, default=5e-5, help="transform module learning rate")
